...
<footer className="bg-gray-100 text-gray-800 py-12">
  <div className="container mx-auto px-4 flex flex-col justify-center items-center">
    <div className="w-full  text-center mb-8 md:mb-0">
      <h4 className="text-4xl font-bold mb-2">
        <span className="text-purple-400">Sixth</span>
    ...
    <div className="w-full  text-center mb-8 md:mb-0">
      <h5 className="text-lg m-auto font-bold mb-4">Quick Links</h5>
      <ul className="border list-none m-auto mb-4 w-auto md:flex  items-center justify-between">
        <li className="mb-2">
          <a href="#" className="text-gray-700 hover:text-purple-400">
            Home
          </a>
        </li>
        <li className="mb-2">
    ...
    <div className="w-full  text-center">
      ...
      <div className="flex justify-center md:justify-start">
        <a href="#" className="text-gray-700 hover:text-purple-400 mx-2">
          <i className="fab fa-twitter"></i>
        </a>
        <a href="#" className="text-gray-700 hover:text-purple-400 mx-2">
          <i className="fab fa-facebook-f"></i>
        </a>
        <a href="#" className="text-gray-700 hover:text-purple-600 mx-2">
  ...
  <div className="border-t-2 border-gray-200 mt-8 pt-8 text-center">
    <p className="text-gray-700">
      &copy; 2023 <span className="text-purple-600">Sixth</span>
      <span className="text-gray-700"> </span>
      <span className="text-gray-700">Dimension</span>. All rights reserved.
    </p>
  </div>
</footer>
);
...
<footer class="w-full text-gray-700 bg-gray-100 body-font">
  ...
  <div class="bg-gray-300">
    <div class="container px-5 py-4 mx-auto">
      <p className="text-gray-700">
      &copy; 2023 <span className="text-purple-600 font-extrabold">Sixth</span>
      <span className="text-gray-700"> </span>
      <span className="text-blue-700 font-extrabold">Dimension</span>. All rights reserved.
    </p>
    </div>
  </div>
</footer>
